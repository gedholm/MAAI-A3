...
def initial_population():
    ...
    for g in range(0, initial_games):
        score = 0
        ...
        for s in range(goal_steps):
            ...
            one_hot = make_random_one_hot()
            action = make_action(one_hot)
            # do it!
            observation, reward, done, info = env.step(action)
            ...
            if len(prev_observation) > 0 :
                game_memory.append([prev_observation, one_hot])
